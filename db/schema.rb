...
ActiveRecord::Schema.define(version: 2021_02_16_074948) do
  ...
  create_table "motions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "abs", default: 0, null: false
    t.integer "squat", default: 0, null: false
    t.integer "push_ups", default: 0, null: false
    t.integer "spine", default: 0, null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
